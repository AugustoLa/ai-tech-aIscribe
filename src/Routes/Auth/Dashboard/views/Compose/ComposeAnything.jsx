        ...
        <div className='justify-center lg:ml-4 xl:mt-[13rem]  items-center w-full text-center lg:mt-[5rem] md:mt-[1rem]'>
            ...
            <div className='p-4 border grid lg:grid-cols-4 md:grid-cols-2 gap-y-4 sm:grid-cols-1'>
                {sections.map((infos) => {
                    return (
                        <Link to={infos.to}>
                            <div className='rounded-md bg-gray-100 text-end items-end shadow-2xl md:max-h-[20rem] md:min-h-[15rem] md:max-w-[20rem] mx-2'>
                                <div className='mx-2 my-4 py-3 flex flex-col items-end'>
