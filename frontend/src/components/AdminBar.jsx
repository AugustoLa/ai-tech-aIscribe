...
function AdminBar() {
    return (
        <>
            <div className='bg-blue-500 flex md:hidden flex-row items-center justify-between h-[5vh] w-full'>
            ...
            <div className='bg-blue-500 hidden md:flex flex-row items-center justify-between h-[5vh] w-full'>
                <div className='flex flex-row m-3'>
                    <Link to=''>
                        <p className='text-xl p-2  bg-gray-300/10 rounded-md'><BiLogOut /></p>
                    </Link>
