...
import {
    AiOutlineArrowLeft, AiOutlineBulb, AiOutlineContainer, AiOutlineAlignRight,
    AiOutlinePhone, AiOutlineRobot, AiOutlineShop, AiOutlineClose, AiOutlineMenu
} from 'react-icons/ai'
    ...
    return (
        <>
            ...
            <div className={`flex`} onClick={handleClose}  >
                {/* Ai Content Tech */}
                <div className="h-[95vh] flex-1 p-7">
                    <Outlet></Outlet>
                </div>
                {/* Large Devices sidebar*/}
                <div className={`hidden md:block w-60 duration-500 h-[95vh] bg-gray-100 border border-l-gray-900 border-b-gray-900 relative`}>
                    ...
                    <ul className='pt-6'>
                        {Menus.map((menu, index) => {
                            ...
                            if (index === 5) {
                                return (
                                    <li className={`mx-2 text-sm flex flex-col items-end h-[5rem] p-2 rounded-md border border-gray-700/40  ${menu.gap ? "mt-[12vh]" : "mt-2"}`} key={index}>
