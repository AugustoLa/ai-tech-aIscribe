...
function EmailResponder() {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    const textMessage = `You need to reply to the following email: ${email}. The response will have a ${voiceTone} tone of voice and 
    the name of you're addressing is ${to}the purpose of the response is: ${message}`;
        ...
        <div className='w-full'>
          ...
          <div className='flex flex-col'>
            ...
            <textarea className='py-2 h-48 text-sm pl-2 mb-6 border border-[#b8c7e5] bg-white rounded-lg w-full px-2'
              placeholder='email to respond here' value={email} onChange={(e) => setEmail(e.target.value)}></textarea>
            ...
            <input className='text-sm pl-2 mb-6 border border-[#b8c7e5] bg-white rounded-lg h-12 w-full px-2'
              type='text' placeholder='ex: Say thanks' value={message} onChange={(e) => setMessage(e.target.value)} />
